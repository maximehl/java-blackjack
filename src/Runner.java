...
public class Runner {
    public static void main(String[] args){
        ...
        while(playingGame>0){
            ...
            while(!((roundBet>0&&roundBet<=bettingMoney)||takingLoan)){
            ...
            if(roundBet>0){
                ...
                dealerValue = croupier.valueOfHand();
                handValue = you.valueOfHand();
                if(dealerValue>21){
        ...
        if(bettingMoney>1000){
            System.out.println("You leave the blackjack table. You now have " + Double.toString(bettingMoney)
                    + "0, which is " + Double.toString(bettingMoney-1000) + "0 more than you started. " +
                    "Congratulations!");
        }else if(bettingMoney>=0){
            System.out.println("You leave the blackjack table. You now have " + Double.toString(bettingMoney)
                    + "0, which is " + Double.toString(1000-bettingMoney) + "0 less than you started. " +
